 ...
 */
public class PhysicsDragBall extends AppCompatTextView {
    ...
    public PhysicsDragBall(Context context) {
        super(context);
        initDragBall(context);
    }

    public PhysicsDragBall(Context context, AttributeSet attrs) {
        super(context, attrs);
        initDragBall(context);
    }


    public PhysicsDragBall(Context context, AttributeSet attrs, int defStyleAttr) {
